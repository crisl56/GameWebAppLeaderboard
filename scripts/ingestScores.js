...
// metaurl give us the end point we are in
...
async function pushScores() {
	...
	for (const player of MOCK_PLAYERS) {
		...
		// aaaaaaa
		// Spreads the score into an array and grabs the highest number
	...
	console.log("Pushed Data! yayayayayayayayayayayayayayayayayayayay")
}
